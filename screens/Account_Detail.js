...
class Profile_settings extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = {
            errorMessage: null, image: null, location: null,
            about: this.props.user.about,
            carrier: this.props.user.carrier
            , loader: false
            , institute:  this.props.user.institute
            , interest: this.props.user.interest, min_age: this.props.user.min_age, max_age: this.props.user.max_age, age_type: null, gender: null
        }
    }
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    ><Ionicons name="md-arrow-round-back" size={32} style={{ lineHeight: 50,paddingRight:10 }} /><Text style={{ fontSize: 20, lineHeight: 50 }}>Account Details</Text></TouchableOpacity>
